...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/vieCitoyenne/vieCitoyenne_leCodeDeLaRoute/vieCitoyenne_leCodeDeLaRoute_documents';

        $_SESSION['directory2'] = 'vieCitoyenne_leCodeDeLaRoute_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : vie citoyenne : le code de la route</small></h1>
