...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/viePrivee/viePrivee_laFamille/viePrivee_laFamille_documents';

        $_SESSION['directory2'] = 'viePrivee_laFamille_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : Vie privée : La famille</small></h1>
