...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/vieCitoyenne/vieCitoyenne_leBenevolat/vieCitoyenne_leBenevolat_documents';

        $_SESSION['directory2'] = 'vieCitoyenne_leBenevolat_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : vie citoyenne : le bénévolat</small></h1>
