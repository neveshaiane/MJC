...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/viePrivee/viePrivee_lesSouhaits/viePrivee_lesSouhaits_documents';

        $_SESSION['directory2'] = 'viePrivee_lesSouhaits_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : Vie privée : Les souhaits</small></h1>
