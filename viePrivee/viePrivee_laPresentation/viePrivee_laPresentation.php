...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/viePrivee/viePrivee_laPresentation/viePrivee_laPresentation_documents';

        $_SESSION['directory2'] = 'viePrivee_laPresentation_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : Vie privée : La présentation</small></h1>
