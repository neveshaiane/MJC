...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/vieCitoyenne/vieCitoyenne_lEcologie/vieCitoyenne_lEcologie_documents';

        $_SESSION['directory2'] = 'vieCitoyenne_lEcologie_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : vie citoyenne : l'écologie</small></h1>
