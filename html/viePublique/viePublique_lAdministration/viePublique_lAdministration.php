...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/viePublique/viePublique_lAdministration/viePublique_lAdministration_documents';

        $_SESSION['directory2'] = 'viePublique_lAdministration_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : Vie publique : l'administration</small></h1>
