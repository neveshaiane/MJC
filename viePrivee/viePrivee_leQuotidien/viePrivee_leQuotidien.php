...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/viePrivee/viePrivee_leQuotidien/viePrivee_leQuotidien_documents';

        $_SESSION['directory2'] = 'viePrivee_leQuotidien_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : Vie privée : Le quotidien</small></h1>
