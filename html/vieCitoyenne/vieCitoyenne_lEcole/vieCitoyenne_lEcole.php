...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/vieCitoyenne/vieCitoyenne_lEcole/vieCitoyenne_lEcole_documents';

        $_SESSION['directory2'] = 'vieCitoyenne_lEcole_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : vie citoyenne : l'école</small></h1>
