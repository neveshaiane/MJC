...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/viePrivee/viePrivee_laSante/viePrivee_laSante_documents';

        $_SESSION['directory2'] = 'viePrivee_laSante_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : Vie privée : La santé</small></h1>
