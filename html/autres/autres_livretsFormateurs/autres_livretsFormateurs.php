...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/autres/autres_livretsFormateurs/autres_livretsFormateurs_documents';

        $_SESSION['directory2'] = 'autres_livretsFormateurs_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : autres : Guides et livrets pour les formateurs</small></h1>
