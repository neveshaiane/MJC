...
<html lang="fr">
    ...
    <?php
        session_start();
        $_SESSION['directory1'] = '../html/viePrivee/viePrivee_relationsSociales/viePrivee_relationsSociales_documents';

        $_SESSION['directory2'] = 'viePrivee_relationsSociales_documents';
    ?>
    <body>
        <header>
        ...
        <main>
            <section>
                ...
                <h1><small>Dossier : Vie privée : Les relations sociales</small></h1>
